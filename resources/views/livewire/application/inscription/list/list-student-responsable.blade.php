                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            <a class="dropdown-item"wire:click="getResponsable({{ $responsable }})"
                                                ...
                                                href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                            ...
                                            <a class="dropdown-item" wire:click="show({{ $responsable }})"
                                                data-toggle="modal" data-target="#editFamillyModal" href="#">
                                                <i class="fas fa-edit    "></i> Editer une famille</a>
                                            <a class="dropdown-item" wire:click="delete({{ $responsable->id }})"
                                                href="#">
