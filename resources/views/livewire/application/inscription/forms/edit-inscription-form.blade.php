<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="formEditInscriptionModal" data-backdrop="static" data-keyboard="false"
        tabindex="-1" role="dialog" aria-labelledby="formEditInscriptionModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formEditInscriptionModalLabel">MISE A JOUR INFORMATION DE L'ELEVE</h5>
                    <button wire:click='resetFrom' type="button" class="close" data-dismiss="modal"
                        aria-label="Close">
                ...
                @if ($student)
                    <form wire:submit='update'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <x-form.input class="" type='date' wire:model='date_of_birth' />
                                        @error('date_of_birth')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <x-select wire:model='student_responsable_id'>
                                            ...
                                            @foreach ($listResonsable as $responsable)
                                                <option value="{{ $responsable->id }}">
                                                    {{ $responsable->name_responsable }}</option>
                                            @endforeach
                                        </x-select>
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <x-form.button wire:click='resetFrom' type="button" class="btn btn-danger"
