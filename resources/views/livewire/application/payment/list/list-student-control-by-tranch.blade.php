<div class="card">
    <div class="card-header text-uppercase">
        <h4>
            <i class="fa fa-arrow-right" aria-hidden="true"></i> {{ $typeCost->name }}
        </h4>
    </div>
    <div class="card-body">
        <div class="d-flex align-items-center">
            <div class="form-group ml-2">
                ...
                <x-widget.list-cost-general-select-widget type='{{ $selectedIndex }}' wire:model.live='cost_general_id' />
            </div>
            <div class="form-group ml-2">
            ...
            <table class="table table-stripped table-sm ">
                ...
                <tbody>
                    @foreach ($listStudent as $index => $inscription)
                        @php
                            $status = $inscription->getByCurrentYearBycostPaymentCheckerStattusByTranch($selectedIndex, $inscription->student->id, $cost_general_id, $defaultScolaryYerId);
                        @endphp
                        <tr>
